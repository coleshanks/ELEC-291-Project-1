...
$LIST
	...
	Initial_Message5:  db '1 		', 0
	Initial_Message6:  db '2 		', 0
...
MainProgram:
	...
	mov temp_soak_FSM, 		#150
	mov time_soak_FSM, 		#60
	mov temp_refl_FSM,		#220
	mov time_refl_FSM, 		#45
...
hop:
	...
	Set_Cursor(1,5)
	Send_Constant_String(#Initial_Message5)
	Set_Cursor(1,6)
	...
	Set_Cursor(2,5)
	Send_Constant_String(#Initial_Message6)
	Set_Cursor(2,6)
...
set_temp_soak_FSM:
	mov a, temp_soak_FSM
	cjne a, #180, change_temp_soak_FSM
	mov a, #129
	mov temp_soak_FSM, a
change_temp_soak_FSM:
	add a, #1
	mov temp_soak_FSM, a
...
set_time_soak_FSM:
	mov a, time_soak_FSM
	cjne a, #80, change_time_soak_FSM
	mov a, #39
	mov time_soak_FSM, a
change_time_soak_FSM:
	add a, #1
	mov time_soak_FSM, a
...
set_temp_refl_FSM:
	mov a, temp_refl_FSM
	cjne a, #250, change_temp_refl_FSM
	mov a, #200
	mov temp_refl_FSM, a
change_temp_refl_FSM:
	add a, #1
	mov temp_refl_FSM, a
...
set_time_refl_FSM:
	mov a, time_refl_FSM
	cjne a, #65, change_time_refl_FSM
	mov a, #24
	mov time_refl_FSM, a
change_time_refl_FSM:
	add a, #1
	mov time_refl_FSM, a
